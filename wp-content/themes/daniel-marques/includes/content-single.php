...
<div id="post-<?php the_ID(); ?>" <?php post_class( $classes ); ?>>
	...
	<div class="post-wrapper-content">
		...
		<div class="entry-share">
			<span><?php _e('Compartilhar: ' ); ?></span>
			<a class="popup facebook" href="<?php echo esc_url( 'https://www.facebook.com/sharer/sharer.php?u=' . get_the_permalink() ); ?>"><i class="icon-facebook"></i></a>
			<a class="popup twitter" href="<?php echo esc_url( 'http://twitter.com/share?text=' . urlencode( get_the_title() ) . '&amp;url=' . urlencode( get_the_permalink() ) ); ?>"><i class="icon-twitter"></i></a>
			<a class="popup pinterest" href="<?php echo esc_url( 'http://pinterest.com/pin/create/button/?url=' . urlencode( get_the_permalink() ) . '&amp;media=' . urlencode( get_the_permalink() ) . '&amp;description=' . urlencode( get_the_excerpt() ) ); ?>"><i class="icon-gplus"></i></a>
			<a class="popup googleplus" href="<?php echo esc_url( 'https://plus.google.com/share?url=' . get_the_permalink() ); ?>"><i class="icon-pinterest"></i></a>
		</div>

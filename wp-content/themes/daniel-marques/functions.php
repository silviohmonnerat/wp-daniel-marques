...
require_once( LIBS_DIR .'/meta-atuacao.php' );
require_once( LIBS_DIR .'/meta-projetos-de-lei.php' );
require_once( LIBS_DIR .'/meta-defesa-do-contribuinte.php' );
//require_once( LIBS_DIR .'/meta-seguranca.php' );
//require_once( LIBS_DIR .'/meta-frente-parlamentar.php' );
...
require_once( LIBS_DIR .'/widget-count-post-views.php' );
require_once( LIBS_DIR .'/widget-instagram.php' );
require_once( LIBS_DIR .'/widget-facebook.php' );
require_once( LIBS_DIR .'/widget-media-upload.php' );
...
// Tool box ------------------------------------
require_once( THEME_DIR .'/wp-toolbox/init.php' );
...
if( ! function_exists( 'mfn_vc_integrateWithVC' ) )
{
	function mfn_vc_integrateWithVC() {
		...
		// Goolge maps in posts ----------------------------------------
		// vc_map( array (
		// 	'base' 			=> 'post_map',
		// 	'name' 			=> __('Google Maps Posts', 'mfn-opts'),
		// 	'category' 		=> __('Personalizada', 'mfn-opts'),
		// 	'icon' 			=> 'mfn-vc-icon-laws',
		// 	'params' 		=> array (
		...
		// 			'description' 	=> __('Add title', 'mfn-opts'),
		// 			'admin_label'	=> false,
		// 		),
		...
		// 			'type' 			=> 'textfield',
		// 			'heading' 		=> __('Tipo de post', 'mfn-opts'),
		// 			'description' 	=> __('Add tipo de post', 'mfn-opts'),
		// 			'admin_label'	=> false,
		// 		),
		...
		// 			'param_name' 	=> 'api_key',
		// 			'type' 			=> 'textfield',
		// 			'heading' 		=> __('API Key do google maps', 'mfn-opts'),
		// 			'description' 	=> __('chave de autenticação do google maps', 'mfn-opts'),
		// 			'admin_label'	=> true,
		// 		),
		...
		// 			'param_name' 	=> 'mapa_id',
		// 			'type' 			=> 'textfield',
		// 			'heading' 		=> __('Nome do mapa', 'mfn-opts'),
		// 			'description' 	=> __('Adicionar um nome para o mapa sem espaço e caracteres especiais', 'mfn-opts'),
		// 			'admin_label'	=> true,
		// 		),
		...
		// 			'param_name' 	=> 'width',
		// 			'type' 			=> 'textfield',
		// 			'heading' 		=> __('Largura do mapa', 'mfn-opts'),
		// 			'description' 	=> __('A largura pode ser definida tanto com o px quanto %', 'mfn-opts'),
		// 			'admin_label'	=> true,
		// 		),
		...
		// 			'param_name' 	=> 'height',
		// 			'type' 			=> 'textfield',
		// 			'heading' 		=> __('Altura do mapa', 'mfn-opts'),
		// 			'description' 	=> __('A altura pode ser definida tanto com o px quanto %', 'mfn-opts'),
		// 			'admin_label'	=> true,
		// 		),
		...
		vc_map( array (
			'base' 			=> 'defense',
			'name' 			=> __('Defesa do Contribuinte', 'mfn-opts'),
			'category' 		=> __('Personalizada', 'mfn-opts'),
			'icon' 			=> 'mfn-vc-icon-defense',
			'params' 		=> array (
		...
		vc_map( array (
			'base' 			=> 'vvideo',
			'name' 			=> __('Vídeos do Vimeo', 'mfn-opts'),
			'category' 		=> __('Personalizada', 'mfn-opts'),
			'params' 		=> array (
				...
				array (
					'param_name' 	=> 'user_id',
					'type' 			=> 'textfield',
					'heading' 		=> __('User ID Vimeo', 'mfn-opts'),
					'description' 	=> __('Add user id account vimeo', 'mfn-opts'),
					'admin_label'	=> false,
				),
				...
				array (
					...
					'type' 			=> 'textfield',
					'heading' 		=> __('Access token vimeo', 'mfn-opts'),
					'admin_label'	=> true,
				),
		...
		vc_map( array (
			'base' 			=> 'fbvideo',
			'name' 			=> __('Vídeos do Facebook', 'mfn-opts'),
			'category' 		=> __('Personalizada', 'mfn-opts'),
			'params' 		=> array (
				...
				array (
					'param_name' 	=> 'v_id',
					'type' 			=> 'textfield',
					'heading' 		=> __('Vídeo ID', 'mfn-opts'),
					'description' 	=> __('Add video id facebook', 'mfn-opts'),
					'admin_label'	=> false,
				),				

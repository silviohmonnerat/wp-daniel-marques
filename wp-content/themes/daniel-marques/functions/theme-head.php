...
if( ! function_exists( 'mfn_styles' ) )
{
	function mfn_styles() 
	{
		...
		wp_enqueue_style( 'mfn-jquery-fancybox', 	THEME_URI .'/assets/fancybox/jquery.fancybox.css', false, THEME_VERSION, 'all' );
...
if( ! function_exists( 'mfn_scripts' ) )
{
	function mfn_scripts() 
	{
		if( ! is_admin() ){
			...
			wp_enqueue_script( 'jquery-fancybox', 		THEME_URI. '/assets/fancybox/jquery.fancybox.js', false, THEME_VERSION, true );
